...
public class EventoDTO {
    ...
    private Long id;
    @Size(max = 100, min = 3, message = "Título deve ter entre 3 e 100 caracteres")
    @NotBlank(message = "Título é obrigatório")
    private String titulo;
    @Size(max = 1000, min = 10, message = "Descrição deve ter entre 10 e 1000 caracteres")
    @NotBlank(message = "Descrição é obrigatório")
    private String descricao;
    @Future(message = "Data do evento deve ser no futuro")
    @NotNull(message = "Data do evento é obrigatório")
    private LocalDateTime dataEvento;
    @Size(max = 200, min = 3, message = "Local do evento deve ter entre 3 e 200 caracteres")
